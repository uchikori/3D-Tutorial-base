...
async function init() {
  ...
  folder2
    .add(material.uniforms.uScaleTime, "value", 0.001, 1, 0.01)
    .name("ScaleTime");
  folder2
    .add(material.uniforms.uScaleDelay, "value", 0, 10, 1)
    .name("ScaleDelay");

  // const folder3 = gui.addFolder("Extra");
  // folder3.add(material.uniforms.uTick, "value", 0, 1000, 1).name("Tick");
